                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                    <div class="card-body">
                                        <div class="billing-address-form">                       
                                            <form action="/JavaWebProjekt/EditCategory">
                                                ...
                                                <p><input type="text"  placeholder="Name*" name="name" value="<%=c.getName()%>" style="border: 1px solid #ddd; padding: 15px; width: 100%; border-radius: 3px;" required ></p>
